...
const User = () => {
  ...
  const getApiData = async () => {
    try {
      let res = await axios.get("https://api.muslimmalikrishte.com/api/v1/adminPanel/allUsers")
  ...
  const deleteRecord = async (_id) => {
    try {
      let res = await axios.delete("https://api.muslimmalikrishte.com/api/v1/adminPanel/updateUser/" + _id)
      if (res.status === 200) {
